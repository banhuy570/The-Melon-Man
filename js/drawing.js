...
game.redraw = function () {
  ...
  game.counter.innerHTML = "A game by Karol Swierczek | Controls: A, D / arrows and SPACE | Points: " + game.score + " | High Score:" + game.highScore;
};
...
game.requestRedraw = function () {
  ...
  if(game.isOver) {
    ...
    game.context.fillText("Current Score: " + game.score, game.canvas.width / 2, game.canvas.height / 2 + 50)
    game.context.fillText("Highest Score: " + game.highScore, game.canvas.width / 2, game.canvas.height / 2 + 80)
    game.context.font = "15px Georgia"
    game.context.fillText("(Refresh the page to restart)", game.canvas.width / 2, game.canvas.height / 2 + 100)
